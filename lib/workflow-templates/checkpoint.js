...
export function parseWorkflowCheckpoint(raw) {
    ...
    if (x.version !== 2 ||
        ...
        typeof x.pendingRequest !== "boolean" ||
        ...
        !safeInteger(x.report.creditsCharged, Number.MAX_SAFE_INTEGER) ||
        typeof x.report.requestUncertain !== "boolean" ||
    ...
    const report = {
        ...
        requestUncertain: r.requestUncertain,
    ...
    return {
        ...
        pendingRequest: x.pendingRequest,
